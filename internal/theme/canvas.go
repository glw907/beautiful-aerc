...
// an earlier one (the mechanism LayoutMode's Main doc comment
...
// internal/ui's compositing logic, which is pure LayoutMode
...
// only to the canvas's edge, so it silently overlaps whatever
