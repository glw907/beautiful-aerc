...
// bodyPart holds extracted email body content, its MIME type, and the header
// fields needed for empty-body synthesis.
...
// falling back to text/plain. The returned bodyPart also carries the Subject
// and From display name from the message headers for use in empty-body synthesis.
// Returns an error when neither text/html nor text/plain is present.
